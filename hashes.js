...
(function () {
   ...
   */
     ...
     */
        Base64: function () {
            // private properties
            var tab = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/', pad = '=',
                // default pad according with the RFC standard
                url = false,
                // URL encoding support @todo
                utf8 = true;
            // by default enable UTF-8 support encoding
     ...
     */
       ...
       */
            function binb(x, len) {
                var j, i, l, W = new Array(80), hash = new Array(16),
                    //Initial hash values
                    H = [
                    ...
                    ], T1 = new int64(0, 0), T2 = new int64(0, 0), a = new int64(0, 0), b = new int64(0, 0), c = new int64(0, 0), d = new int64(0, 0), e = new int64(0, 0), f = new int64(0, 0), g = new int64(0, 0), h = new int64(0, 0),
     ...
     */
       ...
       */
            function binl(x, len) {
                var T, j, i, l, h0 = 1732584193, h1 = 4023233417, h2 = 2562383102, h3 = 271733878, h4 = 3285377520, A1, B1, C1, D1, E1, A2, B2, C2, D2, E2;
                /* append padding */
                x[len >> 5] |= 128 << len % 32;
                x[(len + 64 >>> 9 << 4) + 14] = len;
                l = x.length;
    ...
    (function (window, undefined) {
        ...
        module.exports = Hashes || module.exports;;
    }(this));
}());    // IIFE
